...
but for this demo, we will enable **gasless transactions** and use a [InAppWallet](/references/react/v4/inAppWallet) as the personal wallet.

```tsx
import { smartWallet, inAppWallet } from "@thirdweb-dev/react";
