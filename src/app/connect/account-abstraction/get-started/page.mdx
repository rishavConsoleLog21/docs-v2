...
```tsx
import { ThirdwebProvider, ConnectWallet, smartWallet, inAppWallet } from "@thirdweb-dev/react";
...
return (
    <ThirdwebProvider
      ...
      supportedWallets={[
        smartWallet(
          inAppWallet(), // any personal wallet
          {
...
```tsx
import { ThirdwebProvider, ConnectWallet, smartWallet, inAppWallet } from "@thirdweb-dev/react-native";
